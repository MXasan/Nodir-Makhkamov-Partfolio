            ...
            <div className="py-16 sm:py-24">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {services.map((service) => (
                        <div key={service.title} className="p-6 border rounded-2xl border-zinc-100  border-zinc-800 bg-white  bg-zinc-900 shadow-sm">
                            <h3 className="text-lg font-semibold text-zinc-900  text-zinc-100 mb-2">
                                {service.title}
                            </h3>
                ...
                <div className="mt-16 text-center">
                    <p className="text-zinc-600  text-zinc-400 mb-4">Interested in working together?</p>
                    <Link
                        href="/contact"
